...
- `https://konvict-artz-backend-production.up.railway.app/health` works
- the current live backend URL is `https://konvict-artz-backend-production.up.railway.app`
...
1. Railway environment variables must be present in the live `konvict-artz-backend-production.up.railway.app` service
