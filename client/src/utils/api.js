...
export const api = {
  ...
  getAffiliateInvites: () => request("/admin/affiliate-invites"),
  createAffiliateInvite: (body) => request("/admin/affiliate-invites/create", { method: "POST", body: JSON.stringify(body) }),
