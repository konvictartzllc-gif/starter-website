    ...
    <div className="min-h-screen bg-gray-950 text-white px-6 py-12">
      <div className="max-w-3xl mx-auto">
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-400">
            We do not sell your personal information. We may share data with trusted third-party service providers to perform functions on our behalf, such as payment processing (Stripe), email delivery, and AI processing (OpenAI). These providers are obligated to protect your data.
          </p>
        </section>
