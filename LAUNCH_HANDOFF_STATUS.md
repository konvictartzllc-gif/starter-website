...
- Live Railway diagnostics are green at `https://konvict-artz-backend-production.up.railway.app/api/diagnostics/providers`:
  - AI ready
  - email ready
  - RingCentral ready
  - Stripe ready
...
- Frontend production API wiring points to `https://konvict-artz-backend-production.up.railway.app/api`.
- Android default backend points to `https://konvict-artz-backend-production.up.railway.app/api`.
...
1. Railway backend
   ...
   - Open `https://konvict-artz-backend-production.up.railway.app/api/diagnostics/providers`.
